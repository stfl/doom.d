...
(defun stfl/agenda-day ()
  '(agenda "Agenda"
           ((org-agenda-use-time-grid t)
            ...
            (org-agenda-span '1)
            (org-super-agenda-groups stfl/org-super-agenda-today-groups)  ;; TODO I can possible use (:discard stfl/primary-work-tags)
...
(setq stfl/org-super-agenda-today-groups
      '((:time-grid t :order 0)
        (:name "Tickler" :tag "SOMEDAY" :order 20)
        (:name "Habits" :tag "HABIT" :habit t :order 90)
