...
(use-package! turbo-log
  ...
  :config
  (map! :leader
        :n "l l" #'turbo-log-print
        :n "l i" #'turbo-log-print-immediately
        :n "l h" #'turbo-log-comment-all-logs
        :n "l s" #'turbo-log-uncomment-all-logs
        :n "l [" #'turbo-log-paste-as-logger
        :n "l ]" #'turbo-log-paste-as-logger-immediately
        :n "l x" #'turbo-log-delete-all-logs)
