...
;; (custom-set-faces '(+org-todo-cancel ((t (:inherit (bold org-todo error)))) ""))
(custom-set-faces! `(+org-todo-cancel :foreground ,(doom-darken (doom-color 'red) 0.5) :inherit (bold org-todo)))
;; (custom-set-faces! '( :inherit error))
#+end_src
