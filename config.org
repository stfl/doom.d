...
Associate =.jsonc= files with =jsonc-mode= (shipped by the =json-mode= package, handles =//= and =/* */= comments). The module already handles =.json= → =json-ts-mode= via tree-sitter.
