...
(after! org-clock
  ...
  ;; (defun stfl/org-clock-in (&optional select)
  ;;   (interactive "P")
  ...
  ;; (defun stfl/org-clock-in-last (&optional arg)
  ;;   (interactive "P")
  ;;   (let ((org-clock-continuously
  ;;          (and org-clock-out-time
  ;;               (> (stfl/org-time-minutes-ago org-clock-out-time) stfl/org-clock-continous-threshold)
  ...
  (defadvice! stfl/org-clock-continue? (orig-fn &optional select start-time)
    ...
    (let ((org-clock-continuously
           (and org-clock-out-time
                ...
                (y-or-n-p (format "You stopped another clock at %s; start this one from then? "
                                  (stfl/org-time-format-ago org-clock-out-time))))))
          (apply orig-fn select start-time)))

  (undefadvice! stfl/org-clock-continue? orig-fn &optional select start-time)

  ;; (map! :map org-mode-map
  ;;       :localleader
  ;;       :prefix ("c" . "clock")
  ;;       "i" #'stfl/org-clock-in
  ;;       "I" #'stfl/org-clock-in-last)
  
  ;; (map! :map org-mode-map
  ;;       :leader
  ;;       :prefix ("n" . "notes")
  ;;       "c" #'stfl/org-clock-in-last)
  )
