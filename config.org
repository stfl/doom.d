...
(after! org-modern
  (setq! org-modern-priority
         '((?A . "⛔")
           ...
           (?H . "𐠠")
           (?I . "҉"))
         org-modern-priority-faces '((?A :inverse-video t :foreground "red3" :weight bold :height .95)
...
the +org-priority-* faces will be transferred into org-modernd-priority-faces in
doom's (org +pretty) module
