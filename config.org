...
** Formatting - Ensure blank lines between headings and before contents
...
exist after each headings's drawers."
  ...
  (save-excursion
    ...
    (unless (bolp)           ; Check if we are not already at the beginning of a line
      (insert "\n"))         ; Insert a newline
    (unless (looking-at "^$") ; Check if there's no blank line
      (insert "\n"))          ; Insert a blank line
    )
