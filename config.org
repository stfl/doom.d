...
** TODO Auto-saving org-mode files
:PROPERTIES:
  ...
  (setq org-capture-templates
        `(("n" "capture to inbox"
          ...
          ("xs" "Enterprise Support"
           entry
           (file ,(doom-path org-directory "gtd/inbox.org") "Inbox")
           (file ,(doom-path doom-private-dir "templates/template-projects.org"))
           :empty-lines-after 1)
          ("h" "Haushalt")
          ("hw" "Wäsche"
...
(defun stfl/get-support-dir (support-root ticketid title)
  (concat support-root "/" ticketid "-" title))

(defun stfl/create-support-dir (support-root ticketid title)
  (let (support-dir (stfl/get-support-dir support-root ticketid title))
    (when (file-exists-p support-dir)
      (error (format "Support directory already exists %s" support-dir)))
    (mkdir support-dir)))

(defun stfl/capture-suport-dir (support-root)
  (let* ((ticketid (read-string "Ticket ID: "))
         (title (read-string "Title: "))
         (support-dir (stfl/get-support-dir support-root ticketid title)))
    (stfl/create-support-dir support-root ticketid title
                             (list support-dir ticketid title)))
  )
#+end_src
