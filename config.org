...
(use-package! org-clock-csv
  :after org
  :config 
  (defun stfl/org-clock-csv ()
    (let ((org-agenda-files '("~/.org/oebb.org" "~/.org/archive/oebb.org")))
      (org-clock-csv)))
  
  (defun stfl/org-clock-csv-to-file (infiles outfile)
    (let ((org-agenda-files infiles))
      (org-clock-csv-to-file outfile)))

  (defun stfl/org-clock-csv-to-file-oebb ()
    (stfl/org-clock-csv-to-file '("~/.org/oebb.org" "~/.org/archive/oebb.org") "/tmp/org-clock-oebb.csv"))
  
  (defun stfl/org-clock-csv-to-file-pulswerk ()
    (stfl/org-clock-csv-to-file '("~/.org/pulswerk.org" "~/.org/archive/pulswerk.org") "/tmp/org-clock-oebb.csv"))
