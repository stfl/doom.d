...
(use-package! gptel
  ...
  (setq! gptel-directives (assq-delete-all 'perplexity gptel-directives))
  (assq-set 'gptel-directives '(perplexity . "You are Perplxity, a helpful search assistant, living in Emacs.
