...
(defun stfl/get-support-dir (support-root ticketid title)
  (let ((support-dir (concat support-root "/" ticketid)))
    (when (not (file-exists-p support-dir))
      (error (format "Support directory does not exist %s" support-dir)))
    support-dir)
  )
(defun stfl/create-support-dir (support-root ticketid title)
  (let ((support-dir (concat support-root "/" ticketid "-" title)))
