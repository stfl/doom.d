...
(use-package! flyover
  ...
  (setq! flyover-checkers '(flycheck)
         ...
         flyover-levels '(error warning)  ; only show errors with flyover
         
         flyover-use-theme-colors t ;; Use theme colors for error/warning/info faces
         flyover-background-lightness 25 ;; Adjust background lightness (lower values = darker)
         ...
         ;; flyover-max-line-length 80 ;; Maximum length of each line when wrapping messages
         
         flyover-hide-checker-name t
         
         flyover-show-virtual-line nil ;;; Show an arrow (or icon of your choice) before the error to highlight the error a bit more.
